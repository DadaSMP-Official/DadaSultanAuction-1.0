# DadaSultanAuction 1.0

<p align="center"><img src="assets/dadasmp-logo.png" alt="DadaSMP" width="180"></p>


> Evento Asta del Sultano con puntate live, NPC e premi esclusivi.
...
**DadaSultanAuction 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Evento Asta del Sultano con puntate live, NPC e premi esclusivi.

| Field | Value |
| --- | --- |
| Plugin | `DadaSultanAuction` |
| Version | `1.0` |
| Category | Economy and Rewards |
| Main class | `it.dadasmp.sultano.DadaSultanAuctionPlugin` |
| Dependencies | `softdepend: [Vault, DadaShop]` |
...
| Automatic behavior | Runs through events, hooks or internal server logic. |
| Permissions | Includes permission nodes documented below. |

## Commands

This plugin does not expose public commands in `plugin.yml`.

## Permissions

| Permission | Default | Description |
| --- | --- | --- |
| `dadasultano.use` | `true` | Permette di aprire l'asta e puntare. |
| `dadasultano.admin` | `op` | Permette di gestire l'evento. |
...
`release/DadaSultanAuction-1.0.jar`
